...
public class GoogleSearchResultPage {
    ...
    public List<String> findLinks(int amount){
        ...
        return (resultAnchors.stream().map(e -> e.getAttribute("href")).collect(Collectors.toList()));
    }
    public String returnLink(String value){
        //new WebDriverWait(driver, PAGE_LOAD_TIMEOUT).until(ExpectedConditions.urlContains(value.toLowerCase().replaceAll(".com", "")));
